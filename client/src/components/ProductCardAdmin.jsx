  ...
  return (
    <div className='w-36 p-4 bg-white rounded'>
        ...
        <div className='grid grid-cols-2 gap-3 py-2'>
          <button onClick={()=>setEditOpen(true)} className='border px-1 py-1 text-sm border-green-600 bg-farm-cream text-leaf-green hover:bg-farm-cream rounded'>Edit</button>
            ...
            <section className='fixed top-0 left-0 right-0 bottom-0 bg-neutral-600 z-50 bg-opacity-70 p-4 flex justify-center items-center '>
                <div className='bg-white p-4 w-full max-w-md rounded-md'>
                    ...
                    <div className='flex justify-end gap-5 py-4'>
                      ...
                      <button onClick={handleDelete} className='border px-3 py-1 rounded bg-farm-cream border-green-500 text-green-500 hover:bg-farm-cream'>Delete</button>
                    </div>
                </div>
            </section>
          )
