...
import image3 from '../assets/desikit_freshness.png'
        ...
        <div className='p-4 lg:pl-7 text-base lg:text-lg space-y-2'>
            ...
            <div>
              ...
              <div className='flex items-center gap-2 lg:gap-4'>
                <div className='border border-green-600 px-4 py-2 rounded bg-farm-cream w-fit'>
                ...
                {
                  data.discount && (
                    <p className="font-bold text-desikit-green lg:text-2xl">{data.discount}% <span className='text-base text-neutral-500'>Discount</span></p>
                  )
                }
              ...
              
              {
                ...
                : (
                  // <button className='my-4 px-4 py-1 bg-desikit-green hover:bg-leaf-green text-white rounded'>Add</button>
                  <div className='my-4'>
            ...
            <h2 className='font-semibold'>Why choose DesiKit?</h2>
            <div className='grid gap-5'>
                  <div className='flex items-center gap-4 my-4'>
                      ...
                      <div className='text-sm'>
                        <div className='font-semibold'>Fast Farm Delivery</div>
                        <p>Fresh dairy and vegetables delivered to your home the same day from local farms.</p>
                      </div>
                  </div>
                  <div className='flex items-center gap-4 my-4'>
                      <img
                      ...
                      />
                      <div className='text-sm'>
                        <div className='font-semibold'>Fair Farmer Earnings</div>
                        <p>Direct ordering ensures farmers receive a larger share and customers get honest value.</p>
                      </div>
                  </div>
                  <div className='flex items-center gap-4 my-4'>
                      <img
                      ...
                      />
                      <div className='text-sm'>
                        <div className='font-semibold'>Local Farm Freshness</div>
                        <p>Choose from carefully curated dairy and produce items sourced directly from farmers.</p>
                      </div>
                  </div>
            </div>
